...
import com.dil.singles.databinding.FragmentEditInterestInBinding
...
class EditInterestInFragment : BaseFragment() {

    private var fragmentEditInterested: FragmentEditInterestInBinding? = null
    private val binding get() = fragmentEditInterested!!
    ...
    override fun onCreateView(
        ...
        fragmentEditInterested = FragmentEditInterestInBinding.inflate(layoutInflater, container, false)
    ...
    private fun listener(){
        ...
        binding.addInterestBtn.setOnClickListener {
            firebaseDatabase.reference.child(USERS).child(firebaseAuth.uid.toString()).child(PASSION).removeValue()
            editViewModel.addPassion()
        }
        ...
        binding.photographyTxt.setOnClickListener {
            isPassionSelected1 = if (isPassionSelected1) {
                ...
                editViewModel.stringPassion.value =
