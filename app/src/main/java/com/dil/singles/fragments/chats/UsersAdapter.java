...
import static com.dil.singles.helper.Constants.UID;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersViewHolder> {
    ...
    public UsersAdapter(Context context, ArrayList<UserList> users) {
    ...
    public UsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_chat_items, parent, false);
        return new UsersViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UsersViewHolder holder, @SuppressLint("RecyclerView") int position) {
        UserList user = users.get(position);
    ...
    public class UsersViewHolder extends RecyclerView.ViewHolder {
        ...
        LayoutChatItemsBinding binding;

        public UsersViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = LayoutChatItemsBinding.bind(itemView);
        }
    }
